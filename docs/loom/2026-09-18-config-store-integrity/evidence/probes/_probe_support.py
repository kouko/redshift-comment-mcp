"""Shared scaffolding for the adversarial probes of 2026-09-17-credential-resolution-hardening.
...
suite cannot silently disarm them. It is a verbatim sibling of the same file
under 2026-09-17-setup-dialog-write-order/evidence/probes/ — duplicated rather
than imported so that neither change's probes can be disarmed by an edit made
for the other.
