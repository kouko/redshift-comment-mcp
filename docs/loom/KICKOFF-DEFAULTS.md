...
- package-tests: uv run pytest tests/ --ignore=tests/integration --ignore=tests/e2e — the live-cluster tiers stay opt-in behind REDSHIFT_INTEGRATION=1, so the default suite is the unit tier (2026-09-17)
