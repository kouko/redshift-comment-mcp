...
| [redshift-grep-columns](redshift-grep-columns/) | Cross-table column search by keyword (name + comment) across one or all schemas via schema-wide MCP call. | v0.4.0 |
| [redshift-grep-tables](redshift-grep-tables/) | Cross-schema table search by keyword (name + comment) across all schemas via cluster-wide MCP call. | v0.4.0 |
