...
| [redshift-cache-schema](redshift-cache-schema/) | Dump cluster structure to `~/.cache/redshift-comment-mcp/<profile>/` as markdown for offline browsing. Cache, not wiki. | v0.3.0 |
