...
| [redshift-grep-columns](redshift-grep-columns/) | 1 つまたは全スキーマを横断してカラム名／コメントをスキーマワイド MCP 呼び出しでキーワード検索。 | v0.4.0 |
| [redshift-grep-tables](redshift-grep-tables/) | 全スキーマを横断してテーブル名／コメントをクラスタワイド MCP 呼び出しでキーワード検索。 | v0.4.0 |
